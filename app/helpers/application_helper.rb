...
module ApplicationHelper
  ...
  def download_button
    content_tag :button, 'Get TSV', class: ['btn', 'btn-sm', 'btn-outline-secondary', 'download', 'has-tooltip', 'd-none', 'd-md-inline-block'],
                                    type: 'button',
                                    data: { toggle: 'tooltip',
                                            placement: 'right',
  ...
  def caption(collection: nil, family_id: nil, full: false, show_full_core_caption: true)
    ...
    result += {
      'H14CORE' => 'v14 Core collection',
      'H14INVIVO' => 'In vivo collection',
      'H14INVITRO' => 'In vitro collection',
      'H14RSNP' => 'rSNP collection',
    }.fetch(collection, '')
  ...
  def tfclass_family_inner_link(family_id, collection: 'H14CORE')
